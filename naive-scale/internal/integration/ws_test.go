...
// and delivered to connected clients. We connect and confirm the client first (a
// warmup round-trip), so the assertion is about the relay finding the row on a
// poll, not about connect/register timing.
