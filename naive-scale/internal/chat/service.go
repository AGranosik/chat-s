...
// scale out across instances (that swap is the whole point of naive-scale — see
// README.md). The outbox relay is the only caller.
...
// and broadcasts it — no commit-time signalling.
