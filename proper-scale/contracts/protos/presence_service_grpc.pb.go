...
func _UserService_Connect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConnectUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).Connect(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_Connect_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Connect(ctx, req.(*ConnectUserRequest))
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cotnracts.v1.UserService",
	...
	Metadata: "contracts/protos/presence_service.proto",
}
